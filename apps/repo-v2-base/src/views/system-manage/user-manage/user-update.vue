...
<script lang="ts">
import { PropType, Ref, computed, defineComponent, ref, toRef, toRefs, watch } from 'vue';
...
type IProps = ICommonEditor<SystemManage.User.PageItem>;
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const editorForm = toRef(props, 'data');
    ...
    async function onClickSubmitForm() {
      ...
      const res = await SystemManage.updateUser(editorForm.value);
      if (res.code === 200) {
